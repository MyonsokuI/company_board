...
VALUES (101, 101, 'yamada', '$2a$10$6lI.guAbpoUeM/Zq39UW1eOwvSF/rRnGraSKJaZkzqYMMDdvrVuua', 'USER');

-- 連絡メモ（お知らせ）のテストデータ（これまでお使いだったデータを網羅）
INSERT INTO notices (notice_id, title, body, priority, created_by, published_until, created_at) VALUES
(1, '【重要】システム】', '今週末の土曜日 22:00 ～ 日曜日 06:00 の間、サーバーメンテナンスを実施いたします。作業時間中はシステムをご利用いただけません。ご迷惑をおかけしますが、ご理解とご協力をお願いいたします。', 1, 101, '2026-08-30 00:00:00', '2026-08-18 15:24:48.243266'),
(2, '社内懇親会', '来週金曜日の18時より、3階会議室にて8月の社内懇親会を開催します。軽食と飲み物を用意しておりますので、奮ってご参加ください。参加の方は水曜日までにSlackにてご連絡ください。', 2, 101, '2026-08-25 00:00:00', '2026-08-18 15:24:48.251858'),
(3, 'ランチ情報', '総務部より、新しくオープンしたオフィスビル近くの定食屋さんの情報をまとめました。休憩時間のランチの参考に共有いたします。おすすめメニューは日替わりランチです！', 3, 101, NULL, '2026-08-18 15:24:50.020174'),
(4, 'メンテナンス', '今週末の土曜日に定期メンテナンスを実施します。', 1, 101, '2026-08-30 00:00:00', '2026-08-18 14:55:58.760230'),
(5, '社内研修', '来月開催される新人研修についての詳細を共有します。', 2, 101, NULL, '2026-08-18 13:55:58.760230'),
(17, 'システム保守', '今週末にメンテナンスを行います。', 1, 101, '2026-08-31 00:00:00', '2026-08-19 13:37:36.445219'),
(18, 'あいうえお', 'あいうえお', 2, 101, '2026-08-20 00:00:00', '2026-08-19 15:45:27.396056'),
(19, 'あいうえお', 'あいうえお', 2, 101, '2026-08-20 00:00:00', '2026-08-19 15:45:39.909308'),
(20, 'あいうえお', 'あいうえお', 2, 101, '2026-08-20 00:00:00', '2026-08-19 15:54:25.119650'),
(21, 'あいうえお', 'あいうえお', 2, 101, '2026-08-20 00:00:00', '2026-08-19 15:57:10.229686');
